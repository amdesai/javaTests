...
*/
    ...
    static class BinarySearchTree {
        ...
        Node findInOrderSuccessor(Node inputNode) {
            // your code goes here
            Node ans = null;
            if (inputNode == null) return ans;
            Node curr = root;
            while (curr != null) { // curr -> 20 | 9, 12, 11, null
                if (curr.key > inputNode.key) { // probe left subtree inputNode -> 9
                    ans = curr; // ans -> 20, 12, 11
                    curr = curr.left;
                } else { // probe right
                    curr = curr.right;
                }
